...
import com.example.service.apply.createApplicationForm
...
internal class ApplicationFormTest {
    ...
    fun `지원서를 수정한다`() {
        ...
        assertAll(
            {
                assertThat(applicationForm.referenceUrl)
                    .isEqualTo("https://example2.com")
            },
            {
                assertThat(applicationForm.answers.items[0].contents)
                    .isEqualTo("수정된 답변 1")
            }
        )
    }
